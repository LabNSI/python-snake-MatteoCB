...
def jeu(win):
	...
	win.addch(food[0], food[1], chr(211), curses.color_pair(4))  # Prints the food
...
def mange_pomme(win, food, snake, score):
	...
	if snake[0] == food:
		...
		win.addch(food[0], food[1], chr(211), curses.color_pair(4))
		win.refresh()
...
def perdu(win, snake):
	...
	if snake[0] in snake[1:] :
		...
		win.addstr(win.getmaxyx()[0]//2, win.getmaxyx()[1]//2-5, "GAME OVER !", curses.color_pair(5))
		win.refresh()
